...
Ability to adopt for new change constantly

What is scrum 

Agile frame work which suits 70% of agile
This is for work management 


Agile drives human/customer feedback loops to validate what to build iteratively, while DevOps automates technical/system loops to deliver it reliably and continuously

Your platform enforces DevOps by design.

DevOps needs tooling to work at scale.

That tooling is what Platform Engineering builds