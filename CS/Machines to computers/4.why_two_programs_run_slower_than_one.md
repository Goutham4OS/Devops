---
title: 'Why Two Programs Run Slower Than One'
---
...
- No interruptions
- CPU cache stays full of Program A’s data
...
So Program A already takes **~2× longer** in wall-clock time.
...
Program A’s data is **gone from cache**.
...
## 10. Why This Feels Slower Than Just “Half Speed”
...
❌ Program A did NOT restart  
❌ OS did NOT break execution  
❌ CPU did NOT slow down  

✅ CPU lost fast copies of Program A’s data  
✅ Extra RAM access caused delay  
...
> “When multiple programs run, CPU time is divided and each context switch evicts cached data, forcing programs to reload from slower memory, which makes execution slower than a simple time split.”
